$(function(){
    ...
    function setUpdateVille() {

        $('#geo_ville').change(function(){
            console.log("changement ville");
            var $form = $(this).closest('form');
            console.log($(this).closest('form'));
            var data = {};
            //data[$pays.attr('name')] = $pays.val();
    ...
    $('#ajouter').click(function(){
        ...
        $("#geo_visites_"+nb+"_ville").val($('#geo_ville>option:selected').text());
        $("#geo_visites_"+nb+"_idVille").val($('#geo_ville>option:selected').val());
    ...
    $('#ajouter').click(function(){
        ...
        tmpl = tmpl.replace("{***}",$('#geo_ville>option:selected').text());
        tmpl = tmpl.replace("{+++}", $('#geo_ville>option:selected').val());
